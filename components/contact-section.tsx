  ...
  try {
    const response = await emailjs.send(
      ...
      process.env.NEXT_PUBLIC_EMAILJS_TEMPLATE_ID!,
      {
        ...
        time: new Date().toLocaleString(),  // 🕒 Adds local time
      },
              ...
              <Card className="h-full border-gray-200 dark:border-gray-800">
                <CardContent className="p-6 flex flex-col h-full">
                  ...
                  <p className="text-gray-600 dark:text-gray-400 mb-6">
                    I'm currently available for freelance work, full-time positions, and collaborative research projects.
                  ...
                  <div className="flex items-center mb-4">
                    ...
                    <a href="mailto:shindijamekar.1101@gmail.com" className="hover:text-gray-900 dark:hover:text-gray-100 transition-colors">
                  ...
                  <div className="mt-auto">
                    ...
                    <div className="flex space-x-4">
                      <Button variant="outline" size="icon" className="rounded-full hover:bg-gray-100 dark:hover:bg-gray-800 border-gray-300 dark:border-gray-700 bg-transparent" aria-label="GitHub" asChild>
                        <a href="https://github.com/ramshindijamekar" target="_blank" rel="noopener noreferrer">
                          <Github className="h-5 w-5" />
                        </a>
                      </Button>
                      <Button variant="outline" size="icon" className="rounded-full hover:bg-gray-100 dark:hover:bg-gray-800 border-gray-300 dark:border-gray-700 bg-transparent" aria-label="LinkedIn" asChild>
                        <a href="https://www.linkedin.com/in/ram-shindijamekar/" target="_blank" rel="noopener noreferrer">
