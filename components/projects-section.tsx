...
const projects = [
  ...
  },
  {
    ...
    tags: ["Python", "SAM", "Computer Vision", "Fine-Tuning", "OpenCV", "Polygon Simplification", "PyTorch", "Geospatial AI" ],
    github: "#",
    demo: "#",
    isWip: true,
    confidential: true,
  ...
  // 💡 Add more projects like this:
  {
    title: "GoalNetDL",
    description:
      "GoalNetDL leverages deep learning and computer vision to analyze football match footage, enabling player and ball tracking, tactical heatmaps, and event detection for in-depth game intelligence.",
    image: "/images/football2.svg?height=400&width=600", // 🔥 Replace with your actual image path
    tags: ["YOLO", "Computer Vision", "Deep Learning", "Object Tracking",  "OpenCV", "Sports Analytics"],
    github: "#",
    demo: "#", 
    isWip: true,
    confidential: false,
                  ...
                  <CardContent className="p-6 transform transition-transform duration-300 group-hover:translate-y-[-5px]">
                    ...
                    <div className="flex items-center gap-2 flex-wrap mb-2">
                      ...
                      {project.confidential && (
                        <span className="px-2 py-0.5 bg-slate-700 text-white text-xs rounded font-medium">
                          Internal
                        </span>
                      )}
                    </div>
                    ...
                    {/* Conditional links */}
                    {project.confidential ? (
                      <div className="text-sm italic text-gray-500">Private – Internal Use</div>
                    ) : (
                      <div className="flex justify-between opacity-70 group-hover:opacity-100 transition-opacity duration-300">
                        <Button
                          variant="ghost"
                          size="sm"
                          className="px-0 text-gray-600 dark:text-gray-400"
                          onClick={(e) => {
                            e.stopPropagation()
        ...
        >
          ...
          >
            ...
            <div className="p-6">
              ...
              {selectedProject.confidential ? (
                <div className="text-sm italic text-gray-500">Code & demo not available – Internal Project</div>
              ) : (
...
//       "GoalNetDL leverages deep learning and computer vision to analyze football match footage, enabling player and ball tracking, tactical heatmaps, and event detection for in-depth game intelligence.",
//     image: "/images/football2.svg?height=400&width=600", // 🔥 Replace with your actual image path
//     tags: ["Computer Vision", "Deep Learning", "Object Tracking", "YOLO", "OpenCV", "Sports Analytics"],
//     github: "#", // 🔥 Add your GitHub link here
//     demo: "#",   // 🔥 Add your live demo or video demo here
//   },
// ]
